...
{
    public class CrimtaneGhost : ModNPC
    {
        ...
        {
            Item.NewItem((int)npc.position.X, (int)npc.position.Y, npc.width, npc.height, ItemID.CrimtaneOre, Main.rand.Next(9, 17));
            if (Main.rand.Next(10) < 1)
            {
                Item.NewItem(npc.getRect(), ItemID.BloodButcherer, Main.rand.Next(1, 2));
            }
        }
    }
}
