...
namespace CelestialInfernalMod.Items.Weapons
{
	public class Sharanga : ModItem
	{
		...
		public override void AddRecipes() 
		{
			...
			recipe.AddIngredient(mod.ItemType("DemonicBow"), 1);
            recipe.AddIngredient(mod.ItemType("PutridBow"), 1);
            recipe.AddIngredient(mod.ItemType("Sporeshooter"), 1);
            recipe.AddIngredient(mod.ItemType("ShellyIsland"), 1);
